...
Subagent (general-purpose):
  ...
  prompt: |
    ...
    **Diff file:** [DIFF_FILE]
    ...
    this code. Judge whether the tests they wrote match their task's
    test-policy class — too few is a finding, and so is a pile of tests the
    class never called for. Do not re-run the suite to confirm their
